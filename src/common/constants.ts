...
export const LIGHT_THEME_HEADER_COLOR = '#f9f9f9'
export const LIGHT_THEME_FOOTER_COLOR = '#f9f9f9'
export const LIGHT_THEME_BODY_COLOR = '#f5f5f5'
export const GITHUB_URL = 'https://github.com/llipengda/liangyu-oj'
